...
require '../Data/mini_Term_objects_data.php';
?>
...
<link rel="stylesheet" href="jquerytablesorterfile/themesblue/style.css" type="text/css" media="print, projection, screen"/>

<!-- Hide this line for IE (needed for Firefox and others) -->
<![if !IE]>

<link rel="icon" href="http://home.ubalt.edu/id86mp66/Imamapper_favicon.png" type="image/png
<![end
<!-- This is needed for IE
<link rel="shortcut icon" href="home.ubalt.edu/id86mp66/Imamapper_favicon.ico" type="image/ico" />
...
<div id="main">
	...
	<table id="tablesorter-scotus" class="tablesorter" border="0" cellpadding="0" cellspacing="1">
		...
		<?php
			$first_collection->echo_term_rows();
		?>
...
<a name="TermStats"></a>
	...
	<p>
	<ul>
		<li>Number of cases in 2014 Term: <strong>71</strong>. This comes from the list of 2014 Term cases comes from the <a class="external" href="http://scdb.wustl.edu/analysisCaseListing.php?sid=1501-TEARDROP-3854">Supreme Court Database (Spaeth)</a>.</li>
		<li>Average age of network:<strong>36.24 years</strong>. Median age of network:<strong>34.98 years</strong>.</li>
		<li>Average number of 3D cases:<strong>18.51</strong>. Median number of 3D cases:<strong>13</strong>.</li>
		<li>Average number of 2D cases:<strong>6.10</strong>. Median number of 2D cases:<strong>5</strong>.</li>
		<li>Average 3D Degree of Dissent:<strong>0.43</strong>. Median 3D Degree of Dissent:<strong>0.49</strong>.</li>
		<li>Average 2D Degree of Dissent:<strong>0.42</strong>. Median 2D Degree of Dissent:<strong>0.49</strong>.</li>
	</ul>
	</p>
	...
	<p>
		<strong>Limitations</strong>. Pleast note that the tool only recognizes cases for which there is a Supreme Court Database (Spaeth) ID number. Since <a class="external" href="http://scdb.wustl.edu/data.php">Spaeth does not cover pre-1946 Term cases</a>, the tool cannot create networks to cases decided before 1946. In addition, the tool does not allow for citation networks with more than 70 cases in them. If a 3D network has more than 70 cases, the tool will return the 2D network only (in the table, "tb" will appear in the 3D column). Finally,since citations between cases are all parsed by computer, the tool does experience occasional data errors. The most common error is for the parser to fail to recognize non-standard cites to recent cases. 
	</p>
